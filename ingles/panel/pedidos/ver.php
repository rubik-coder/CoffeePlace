      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            <li class="active">
              <a href="index.php" class="btn">Orders</a>
            </li> 
            <li>
              <a href="../peliculas/index.php" class="btn">Products</a>
            </li> 
            <li class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    ...
    <div class="roW">
          <div class ="col-md-12">
           ...
           <div class="pull-left">
           <a href="index.php" class="btn btn-default hidden-print">Return</a>
           </div>
           <div class="pull-right">
           <a href="javascript:;" id="btnImprimir" class="btn btn-danger hidden-print">Print</a>
           </div>
        ...
        <br>
        <br>
        <p>All rights reserved - Coffe Place © - 2020 </p>
    </div> <!-- /container -->
