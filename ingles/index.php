...
<html lang="en">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li>
              <a href="contacto.html" class="btn">CONTACT US</a>
            </li> 
            <li>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    ...
    <li><a href="bocadillos.php">Snacks</a></li>
    <li><a href="postres.php">Desserts</a></li>
    <li><a href="bebidas.php">Drinks</a></li>
          </ul>
          </li>
          </ul>
        </div><!--/.nav-collapse -->
       ...
       <div class="demo">
          <form class="form-search">
            <div class="input-group">
              <input class="form-control form-text" maxlength="128" placeholder="Search" size="15" type="text" name="busqueda"/>
     ...
     <div class="row">
       ...
       <h4 class="text-center"><?php print $item['titulo']?></h4>
         ...
         ?>
          ...
          <strong><div class="text-center">Price: $<?php print $item['precio']?></div></strong>
          <?php
           }else{}
          ?>
         </div>
