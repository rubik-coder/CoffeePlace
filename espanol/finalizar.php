...
<html lang="en">
  <head>
    ...
    <script
    src="https://www.paypal.com/sdk/js?client-id=AZjZyntOXsJhdLJlSGLsflXAB19J26Gur_51OwJRGJOlz6prXPZVxWNCMsgleOOekTmM1Q6bMzXr_pOw"> // Required. Replace SB_CLIENT_ID with your sandbox client ID.
  </script>
      ...
      <div class="main-form">
        <div class="row">
          ...
          <legend>Completar datos</legend>
            ...
            <p align="center">---PAGO EN EFECTIVO---</p>
            ...
            <br>
            <br>
            <p align="center">---TARJETA DE CREDITO O DEBITO---</p>
            <br>
            <br>
            <form action="">
